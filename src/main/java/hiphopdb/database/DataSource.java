	...
	public DataSource() {
		try {
			...
			Artist a1 = new Artist(1, "Travis Scott", "Jacques Berman Webster II",
					SIMPLE_DATE_FORMAT.parse("30/04/1992"), 2008,
			...
			Artist a2 = new Artist(2, "Quavo", "Quavoious Keyate Marshall",
					SIMPLE_DATE_FORMAT.parse("02/04/1991"), 2009,
			...
			Artist a3 = new Artist(3, "Offset", "Kiari Kendrell Cephus",
					SIMPLE_DATE_FORMAT.parse("14/12/1991"), 2009,
			...
			Artist a4 = new Artist(4, "Lil Uzi Vert", "Symere Woods",
					SIMPLE_DATE_FORMAT.parse("31/07/1994"), 2013,
			...
			Artist a5 = new Artist(5, "Future", "Nayvadius DeMun Wilburn",
					SIMPLE_DATE_FORMAT.parse("20/11/1983"), 2009,
			...
			Artist a6 = new Artist(6, "Drake", "Aubrey Drake Graham",
					SIMPLE_DATE_FORMAT.parse("24/10/1986"), 2001,
			...
			Artist a7 = new Artist(7, "Juicy J", "Jordan Michael Houston",
					SIMPLE_DATE_FORMAT.parse("05/04/1975"), 1991,
			...
			Artist a8 = new Artist(8, "Swae Lee", "Khalif Brown",
					SIMPLE_DATE_FORMAT.parse("07/06/1995"), 2009,
			...
			Artist a9 = new Artist(9, "Slim Jxmmi", "Aaquil Brown",
					SIMPLE_DATE_FORMAT.parse("29/12/1993"), 2009,
			...
			Artist a10 = new Artist(10, "Lil Pump", "Gazzy Garcia",
					SIMPLE_DATE_FORMAT.parse("17/08/2000"), 2016,
			...
			Artist a11 = new Artist(11, "Smokepurpp", "Omar Pineiro",
					SIMPLE_DATE_FORMAT.parse("15/05/1997"), 2013,
			...
			Artist a12 = new Artist(12, "21 Savage", "Shayaa Bin Abraham-Joseph",
					SIMPLE_DATE_FORMAT.parse("22/10/1992"), 2014,
			...
			Artist a13 = new Artist(13, "Cardi B", "Belcalis Marlenis Almanzar",
					SIMPLE_DATE_FORMAT.parse("11/10/1992"), 2015,
			...
			Artist a14 = new Artist(14, "Gucci Mane", "Radric Delantic Davis",
					SIMPLE_DATE_FORMAT.parse("12/02/1980"), 2001,
			...
			Artist a15 = new Artist(15, "Young Thug", "Jeffrey Williams",
					SIMPLE_DATE_FORMAT.parse("16/08/1991"), 2011,
			...
			Artist a16 = new Artist(16, "The Weeknd", "Abel Tesfaye",
					SIMPLE_DATE_FORMAT.parse("16/02/1990"), 2010,
			...
			Artist a17 = new Artist(17, "6ix9ine", "Daniel Hernandez",
					SIMPLE_DATE_FORMAT.parse("08/05/1996"), 2017,
			...
			//Wrld on Drugs
			Track t36 = new Track(36, "Black & White", 52658234, 187, "tracks/36.mp3");
			t36.addArtist(a18);
			Track t37 = new Track(37, "Ain't Livin Right ft. Gunna", 812658234, 232, "tracks/37.mp3");
			t37.addArtist(a5);
			t37.addArtist(a18);
			Track t38 = new Track(38, "Hard Work Pays Off", 42658234, 326, "tracks/38.mp3");
			t38.addArtist(a5);
			t38.addArtist(a18);
			Track t39 = new Track(39, "Fine China", 92658234, 143, "tracks/39.mp3");
			t39.addArtist(a5);
			t39.addArtist(a18);
			Track t40 = new Track(40, "Jet Lag ft. Young Scooter", 322658234, 272, "tracks/40.mp3");
			t40.addArtist(a5);
			t40.addArtist(a18);

			// Albums
			Album al1 = new Album(1, "Harvard Dropout", "HipHop/Rap",
					SIMPLE_DATE_FORMAT.parse("05/07/2018"));
			Album al2 = new Album(2, "ASTROWORLD", "HipHop/Rap",
					SIMPLE_DATE_FORMAT.parse("03/08/2018"));
			// Album al3=new Album(3,"SR3MM","HipHop/Rap",new
			// SimpleDateFormat("dd/MM/yyyy").parse("04/05/2018"));
			Album al3 = new Album(3, "Culture", "HipHop/Rap", SIMPLE_DATE_FORMAT.parse("27/01/2017"));
			Album al4 = new Album(4, "Birds in the Trap Sing McKnight", "HipHop/Rap",
					SIMPLE_DATE_FORMAT.parse("03/08/2018"));
			Album al5 = new Album(5, "Lil Pump", "HipHop/Rap", SIMPLE_DATE_FORMAT.parse("06/10/2017"));
			...
			Album al6 = new Album(6, "Invasion of Privacy", "HipHop/Rap",
					SIMPLE_DATE_FORMAT.parse("05/04/2018"));
			...
			Album al7 = new Album(7, "Luv is Rage 2", "HipHop/Rap",
					SIMPLE_DATE_FORMAT.parse("25/09/2017"));
			Album al8 = new Album(8, "Wrld on Drugs", "HipHop/Rap",SIMPLE_DATE_FORMAT.parse("19/10/2018"));

			//Playlists
			Playlist pl1=new Playlist(1,"Trap Nigga Shit","guccimanemixtapewhen","Realest Nigga shit thas ever been");
			Playlist pl2=new Playlist(2,"i finna kill myself","guccimanemixtapewhen","Emo shit to give a listen while crying bout my x bitch");
			Playlist pl3=new Playlist(3,"fuck school gave myself early dimissal","lilpumpohlilpumpyah","What oldhead niggas call mumble rap");
			Playlist pl4=new Playlist(4,"Chill vibes","lhuijgens","Chill shit to study to");
