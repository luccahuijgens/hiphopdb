...
public DataSource() {
	...
	//Artists
	Artist a1=new Artist(1,"Travis Scott","Jacques Berman Webster II",new SimpleDateFormat("dd/MM/yyyy").parse("30/04/1992"),2008,"Jacques Webster (born April 30, 1992), better known by his stage name Travis Scott (formerly stylized as Travi$ Scott), is an American rapper, singer, songwriter, and record producer.\r\n" + 
			"\r\n" + 
	...
	Artist a2=new Artist(2,"Quavo","Quavoious Keyate Marshall",new SimpleDateFormat("dd/MM/yyyy").parse("02/04/1991"),2009,"Quavious Keyate Marshall (born April 2, 1991), known professionally as Quavo, is an American rapper, singer, songwriter and record producer. He is best known as a member of the rap trio Migos. Quavo is directly related to his fellow Migos members, being Takeoff’s uncle and Offset's cousin.[2]\r\n" + 
			"\r\n" + 
	...
	Artist a6=new Artist(6,"Drake","Aubrey Drake Graham",new SimpleDateFormat("dd/MM/yyyy").parse("24/10/1986"),2001,"Aubrey Drake Graham (born October 24, 1986) is a Canadian rapper, singer, songwriter, record producer, actor, and entrepreneur. Drake initially gained recognition as an actor on the teen drama television series Degrassi: The Next Generation in the early 2000s.\r\n" + 
			"\r\n" + 
	...
	Artist a12=new Artist(12,"21 Savage","Shayaa Bin Abraham-Joseph",new SimpleDateFormat("dd/MM/yyyy").parse("22/10/1992"),2014,"Shayaa Bin Abraham-Joseph (born October 22, 1992), better known by his stage name 21 Savage, is an American rapper.\r\n" + 
			"\r\n" + 
	...
	Artist a13=new Artist(13,"Cardi B","Belcalis Marlenis Almanzar",new SimpleDateFormat("dd/MM/yyyy").parse("11/10/1992"),2015,"Belcalis Marlenis Almanzar (born October 11, 1992) known professionally as Cardi B, is an American rapper. Born and raised in The Bronx, New York City, she first attracted attention for discussing her career as a stripper on social media; coupled with her \"no filter attitude\", she became an Internet celebrity through Instagram. From 2015 to 2017, she appeared as a regular cast member on the VH1 reality television series Love & Hip Hop: New York, and released two mixtapes.\r\n" + 
			"\r\n" + 
	...
	Artist a14=new Artist(14,"Gucci Mane","Radric Delantic Davis",new SimpleDateFormat("dd/MM/yyyy").parse("12/02/1980"),2001,"Radric Delantic Davis (born February 12, 1980), known professionally as Gucci Mane, is an American rapper. Since releasing his debut album Trap House in 2005, Gucci has gone on to release 12 studio albums and over 70 mixtapes. In 2007, Gucci Mane founded his own label, 1017 Records. He helped to pioneer the hip hop subgenre trap music, alongside fellow Atlanta-based rappers T.I. and Young Jeezy.\r\n" + 
			"\r\n" + 
	...
	Artist a16=new Artist(16,"Abel Tesfaye","The Weeknd",new SimpleDateFormat("dd/MM/yyyy").parse("16/02/1990"),2010,"Abel Makkonen Tesfaye (born 16 February 1990), known by his stage name The Weeknd, is a Canadian singer, songwriter, and record producer.[2]\r\n" + 
			"\r\n" + 
	...
	Artist a17=new Artist(17,"Daniel Hernandez","6ix9ine",new SimpleDateFormat("dd/MM/yyyy").parse("08/05/1996"),2017,"Daniel Hernandez (born May 8, 1996), known professionally as 6ix9ine (pronounced \"six nine\") or Tekashi 6ix9ine, is an American rapper. He is known for his unconventional appearance, controversial behavior and brute-force screaming technique in his songs.\r\n" + 
			"\r\n" + 
	...
	//Tracks
	//Harvard Dropout
	Track t1=new Track(1,"Drug Addicts",5098456,176,"https://enzyhub.com/wp-content/uploads/2018/07/Lil_Pump_-_Drug_Addicts.mp3?_=1");
	t1.addArtist(a10);
	Track t2=new Track(2,"iShyne",3857623,153,"http://mp3geek.com/wp-content/uploads/2018/01/Lil_Pump_Carnage_-_i_Shyne_Mp3geek.com.mp3?_=3");
    t2.addArtist(a10);
    Track t3=new Track(3,"ESKETIT",9674623,182,"http://soundtunefy.000webhostapp.com/wp-content/uploads/2018/06/Lil-Pump-ESSKEETIT-Official-Music-Video-1.mp3");
    t3.addArtist(a10);
    Track t4=new Track(4,"Welcome to the Party",4122345,269,"https://dnbshare.com/download/Diplo_French_Montana_Lil_Pump_feat._Zhavia_-_Welcome_to_the_Party.mp3.html?file=Diplo_French_Montana_Lil_Pump_feat._Zhavia_-_Welcome_to_the_Party.mp3&payload=9f144cbe4f2af8b6670215b6b30555a28708688cc04716c9ec938609fe5808ba,1535466297&play=1");
    t4.addArtist(a10);
    
    //Astroworld
	Track t5=new Track(5,"Butterfly Effect",12645734,192,"http://cluesong.co/wp-content/Upload/2018/03/Travis-Scott-Butterfly-Effect.mp3");
	t5.addArtist(a1);
	Track t6=new Track(6,"Can't Say",8146853,199,"https://jambaze.co/wp-content/uploads/2018/08/Travis-Scott-ft-Don-Tolive-Cant-Say.mp3");
	t6.addArtist(a1);
	Track t7=new Track(7,"Houstonfornication",8121636,218,"https://jambaze.co/wp-content/uploads/2018/08/Travis-Scott-Houstonfornication.mp3");
    t7.addArtist(a1);
	Track t8=new Track(8,"Wake Up",10857124,233,"https://jambaze.co/wp-content/uploads/2018/08/Travis-Scott-ft-The-Weeknd-Wake-Up.mp3");
	t8.addArtist(a1);
	Track t9=new Track(9,"Stargazing",8167586,271,"https://jambaze.co/wp-content/uploads/2018/08/Travis-Scott-Stargazing.mp3");
    t9.addArtist(a1);
	
	//SR3MM
	Track t20=new Track(20,"Powerglide",7458935,333,"https://music232.com/wp-content/uploads/2018/03/Rae-Sremmurd-%E2%80%93-Powerglide-Ft.-Juicy-J.mp3?_=4");
    t20.addArtist(a7); t20.addArtist(a8); t20.addArtist(a9);
    Track t21=new Track(21,"Guatemala",12634968,252,"https://96hype.com/wp-content/uploads/2018/04/Swae_Lee_ft_Slim_Jxmmi_-_Guatemala.mp3?_=1");
    t21.addArtist(a8); t21.addArtist(a9);
	
    //Culture
    Track t10=new Track(10,"Slippery",20551863,304,"http://cluesong.co/wp-content/Upload/2018/03/Migos-Slippery-Ft-Gucci-Mane.mp3");
    t10.addArtist(a2);
    t10.addArtist(a3);
    t10.addArtist(a14);
    Track t11=new Track(11,"Bad and Boujee",143502864,334,"http://hitnaija.co/wp-content/uploads/2017/09/Migos_Ft_Lil_Uzi_Vert_-_Bad_And_Boujee_HitNaija.com.mp3?_=1");
    t11.addArtist(a2);
    t11.addArtist(a3);
    t11.addArtist(a4);
    Track t12=new Track(12,"T-Shirt",19746582,245,"http://gistmp3.ng/wp-content/uploads/2017/01/Migos_-_T_shirt_gistmp3.com.mp3?_=2");
    t12.addArtist(a2);
    t12.addArtist(a3);
    Track t13=new Track(13,"Kelly Price",9184762,365,"http://cluesong.co/wp-content/Upload/2018/03/Migos-Kelly-Price-Ft-Travis-Scott.mp3");
    t13.addArtist(a2);
    t13.addArtist(a3);
    t13.addArtist(a1);
    Track t14=new Track(14,"All Ass",8153674,0,"");
    t14.addArtist(a2);
    t14.addArtist(a3);
    
    
    //Lil Pump
    Track t15=new Track(15,"Boss",12658234,0,"");
	t15.addArtist(a10);
    //Deadstar
    ...
    //Albums
    Album al1=new Album(1,"Harvard Dropout","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("05/07/2018"));
    Album al2=new Album(2,"ASTROWORLD","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("03/08/2018"));
	Album al3=new Album(3,"SR3MM","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("04/05/2018"));
	Album al4=new Album(4,"Culture","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("27/01/2017"));
	//Album al5=new Album(5,"Birds in the Trap Sing McKnight","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("03/08/2018"));
	Album al6=new Album(6,"Lil Pump","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("06/10/2017"));
	Album al7=new Album(7,"Deadstar","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("29/09/2017"));
	Album al8=new Album(8,"Starboy","HipHop/R&B",new SimpleDateFormat("dd/MM/yyyy").parse("25/11/2016"));
	Album al9=new Album(9,"Invasion of Privacy","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("05/04/2018"));
	Album al10=new Album(10,"Stay Trippy","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("23/08/2013"));
	Album al11=new Album(11,"Blue Dream & Lean","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("29/11/2011"));
	Album al12=new Album(12,"Sremmlife","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("06/01/2015"));
	Album al13=new Album(13,"Sremmlife 2","HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("12/08/2016"));
