...
public class DataSource {
	...
	public DataSource() {
		try {
			...
			Album al8 = new Album(8, "Wrld on Drugs", "HipHop/Rap",new SimpleDateFormat("dd/MM/yyyy").parse("19/10/2018"));
