...
var albumint=0;
	$.getJSON("http://localhost:8081/hiphopdb/restservices/playlists/"+id, function(playlist){
...
$.getJSON("http://localhost:8081/hiphopdb/restservices/tracks/playlist/"+playlist.id, function(tracks){
