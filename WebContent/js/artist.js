...
$.getJSON("http://localhost:8080/hiphopdb/restservices/artists/"+id, function (artist){
$('#artistheader').append(
...
var firstalbum=0;
$.getJSON("http://localhost:8080/hiphopdb/restservices/albums/"+id+"/albums", function(albums){
	firstalbum=$(albums).first().id*5-1;
});
$.getJSON("http://localhost:8080/hiphopdb/restservices/tracks/artist/"+id+"/top",function(tracks){
